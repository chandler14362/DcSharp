...
public partial class DcParserBaseListener : IDcParserListener {
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterStruct_field([NotNull] DcParser.Struct_fieldContext context) { }
	/// <summary>
	/// Exit a parse tree produced by <see cref="DcParser.struct_field"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitStruct_field([NotNull] DcParser.Struct_fieldContext context) { }
	/// <summary>
